...
<body class="bg-stone-900 text-stone-400">
  <header class="w-full bg-stone-800 py-4">
    <nav class="mx-auto max-w-screen-lg flex justify-between  px-4 md:pd-0">
      ...
      <ul class="flex gap-4">
        <li><a href="/" class="hover:underline font-semibold">Explorar</a></li>
        <li><a href="/meus-livros.php" class="text-lime-500 hover:underline font-semibold">Meus Livros</a></li>
